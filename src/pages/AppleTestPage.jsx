...
function AppleTestPage() {
  ...
  return (
    <div className="apple-test min-h-screen bg-[#f5f5f7] text-[#1d1d1f]">
      ...
      <main>
        <section id="inicio-apple" className="bg-[#fbfbfd] px-5 pt-16 sm:px-8 lg:pt-20">
          <div className="mx-auto grid min-h-[calc(100svh-2rem)] max-w-6xl items-start gap-8 py-8 sm:gap-10 sm:py-10 lg:min-h-[calc(100vh-3rem)] lg:grid-cols-[0.96fr_1.04fr] lg:py-12">
            <Reveal>
