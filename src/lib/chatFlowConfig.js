...
export const defaultChatFlowConfig = {
  ...
  responses: {
    ...
    location: 'Atendo em Nova Friburgo/RJ, na Salud Odontologia às quintas e sábados, e na Naturale Dental Studio às sextas. Se quiser, vejo com você o melhor caminho para agendar.',
    ...
    askDay: '{priorityPrefix} Pra você fica melhor quinta, sexta ou sábado?',
    askPeriod: 'Certo. {dayLabel} você prefere de manhã ou à tarde?',
    readyForWhatsapp: 'Fechado. {dayLabel} de {period}, na {clinic}, parece um bom caminho. Esse dia atendo de {schedule}. Para confirmar o horário certinho, é melhor continuar pelo WhatsApp.',
